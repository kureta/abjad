...
def test_scoretools_Inspection_get_effective_13():
    ...
    abjad.attach(mark_1, staff[0], scope='Staff')
    mark_2 = abjad.MetronomeMark(abjad.Duration(1, 8), 42)
    abjad.attach(mark_2, staff[2], scope='Staff')
...
def test_scoretools_Inspection_get_effective_14():
    ...
    abjad.attach(mark, staff[0], scope='Staff')
...
def test_scoretools_Inspection_get_effective_20():
    ...
    staff = abjad.Staff("c'8 d'8 e'8 f'8")
    abjad.attach('color', staff[1], scope='Staff')
...
def test_scoretools_Inspection_get_effective_21():
    ...
    abjad.attach('red', staff[0], scope='Staff')
    abjad.attach('blue', staff[2], scope='Staff')
    abjad.attach('yellow', staff[4], scope='Staff')
...
def test_scoretools_Inspection_get_effective_22():
    staff = abjad.Staff("c'8 d'8 e'8 f'8")
    abjad.attach('red', staff[-1], scope='Staff', synthetic_offset=-1)
    abjad.attach('blue', staff[0], scope='Staff')
