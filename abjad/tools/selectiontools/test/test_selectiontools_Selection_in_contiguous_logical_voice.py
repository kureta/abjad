...
def test_selectiontools_Selection_in_contiguous_logical_voice_01():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_02():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_03():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_04():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_05():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_06():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_07():
...
def test_selectiontools_Selection_in_contiguous_logical_voice_08():
    r'''False when components belonging to same logical voice are ommitted.
    '''
