...
def test_selectiontools_Selection_in_logical_voice_01():
    ...
    assert abjad.Selection(notes).in_logical_voice()
    assert not abjad.Selection(notes).in_logical_voice(allow_orphans=False)


def test_selectiontools_Selection_in_logical_voice_02():
...
def test_selectiontools_Selection_in_logical_voice_03():
...
def test_selectiontools_Selection_in_logical_voice_04():
...
def test_selectiontools_Selection_in_logical_voice_05():
...
def test_selectiontools_Selection_in_logical_voice_06():
...
def test_selectiontools_Selection_in_logical_voice_07():
...
def test_selectiontools_Selection_in_logical_voice_08():
...
def test_selectiontools_Selection_in_logical_voice_09():
...
def test_selectiontools_Selection_in_logical_voice_10():
...
def test_selectiontools_Selection_in_logical_voice_11():
...
def test_selectiontools_Selection_in_logical_voice_12():
    r'''Logical voice does not extend across anonymous voices.
    Logical voice does not extend across anonymous staves.
    '''
...
def test_selectiontools_Selection_in_logical_voice_13():
...
def test_selectiontools_Selection_in_logical_voice_14():
...
def test_selectiontools_Selection_in_logical_voice_15():
...
def test_selectiontools_Selection_in_logical_voice_16():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_17():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_18():
...
def test_selectiontools_Selection_in_logical_voice_19():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_20():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_21():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_22():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_23():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_24():
    r'''Logical voice can not extend across differently named implicit voices.
...
def test_selectiontools_Selection_in_logical_voice_25():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_26():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_27():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_28():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_29():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_30():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_31():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_32():
    r'''Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_33():
    ...
    leaves = abjad.select(container).by_leaf()
    assert abjad.Selection([leaves[i] for i in outer]).in_logical_voice()
    assert abjad.Selection([leaves[i] for i in middle]).in_logical_voice()
    assert abjad.Selection([leaves[i] for i in inner]).in_logical_voice()
    assert not leaves[:4].in_logical_voice()


def test_selectiontools_Selection_in_logical_voice_34():
    r'''Logical voice does extend across gaps.
    Logical voice can not extend across differently named implicit voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_35():
...
def test_selectiontools_Selection_in_logical_voice_36():
...
def test_selectiontools_Selection_in_logical_voice_37():
...
def test_selectiontools_Selection_in_logical_voice_38():
...
def test_selectiontools_Selection_in_logical_voice_39():
    r'''Logical voice can not extend across differently named voices.
    '''
...
def test_selectiontools_Selection_in_logical_voice_40():
...
def test_selectiontools_Selection_in_logical_voice_41():
    r'''Logical voice can not extend across differently named anonymous voices.
    '''
